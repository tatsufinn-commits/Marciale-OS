...
└── docs/                                # Core Governance & High Council Suite
    ...
    ├── AI_RULES.md                      # The AI Constitution (24 Supreme Laws)
...
MODE: HIGH COUNCIL TASK EXECUTION (LAWS I–XXIV)

MY CURRENT GOAL:
1. Inspect `docs/SYSTEM_STATE.md` and `docs/BUILD_LOGBOOK.md` to see verified production state.
2. Follow `docs/THE_10_COMMANDMENTS_OF_DOCS.md` and `docs/AI_RULES.md` (24 Supreme Laws).
