...
1. **Constitutional Primacy:** All Web Department agents are bound by the **15 Supreme Laws of the AI Constitution** (`/docs/AI_RULES.md`) and `docs/THE_10_COMMANDMENTS_OF_DOCS.md`. No web feature may violate Law I (No Framework Rewrites), Law IV (The One-Bite Rule), Law V (Zero-Hallucination Testing), or Law VI (Zero Cloud Leakage).
