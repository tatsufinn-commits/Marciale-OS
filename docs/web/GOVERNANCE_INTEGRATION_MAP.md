...
```text
 ...
 └────────────────────────────────────────────────────────────────────────────┘
                   ...
                   │ (/docs/AI_RULES.md — 12 Supreme Laws) │
                   └───────────────────┬───────────────────┘
                                       │
                                       ▼
                   ┌───────────────────────────────────────┐
                   │ LEVEL 2: CORE EXECUTIVE SQUAD         │
                   │ (/docs/AGENTS.md — 5 Core Personas)   │
...
2. **Rejected: Duplicate Departmental Constitution:**
   * *Why Rejected:* A second constitution would undermine constitutional primacy. The 12 Supreme Laws in `/docs/AI_RULES.md` remain the single supreme legal standard.
...
* **Consistency:** All 12 Supreme Laws, 5 Core Squad roles, and 7 Web Department roles are mutually non-contradictory.
