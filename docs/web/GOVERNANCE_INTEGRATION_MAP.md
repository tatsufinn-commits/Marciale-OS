...
```text
 ...
 └────────────────────────────────────────────────────────────────────────────┘
                   ...
                   │ (/docs/AI_RULES.md — 15 Supreme Laws) │
                   └───────────────────┬───────────────────┘
                                       │
                                       ▼
                   ┌───────────────────────────────────────┐
...
2. **Rejected: Duplicate Departmental Constitution:**
   * *Why Rejected:* A second constitution would undermine constitutional primacy. The 15 Supreme Laws in `/docs/AI_RULES.md` remain the single supreme legal standard.
...
* **Consistency:** All 15 Supreme Laws, 6 Core Squad roles, and 7 Web Department roles are mutually non-contradictory.
