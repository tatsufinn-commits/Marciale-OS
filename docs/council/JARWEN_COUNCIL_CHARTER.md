...
4. **Heavyweight Construction (`ENGINEER` [MAX] $\rightarrow$ `@the_forge`):**
   * Code is built surgically within explicit specifications with zero extraneous dependencies.
...
$$\text{Supreme Commander} \longrightarrow \text{AI Constitution (Laws I–XIV)} \longrightarrow \text{High Council Charter} \longrightarrow \text{Council Seats} \longrightarrow \text{Domain Leads} \longrightarrow \text{Subordinate Agents} \longrightarrow \text{Repository Evidence}$$
