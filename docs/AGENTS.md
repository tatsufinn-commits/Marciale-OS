...
* **Jurisdiction:**
  * Root `package.json`, `docs/MASTERFIX_PLAN_V1.0.md`, `docs/Refinedplan.md`, `docs/AI_RULES.md`.
...
MANDATORY RULES:
1. Follow your specific jurisdiction and rules in docs/AGENTS.md.
2. Follow the 6 Laws of the AI Constitution in docs/AI_RULES.md.
3. Run `npm test` and verify 100% green checkmarks before concluding.
4. Explain what you changed in simple beginner terms for me!
```
